...
export const getCommunities = () => {
    return http.get('/community/all-communities').then((res) => res.data);
}
...
export const updateCommunityPost = (id: number, postId: number, payload: any) => {
...
export const createCommunityPostComment = (id: number, postId: number, payload: any) => {
    return http.post(`/communities/${id}/posts/${postId}/comments`, payload);
}

export const updateCommunityPostComment = (id: number, postId: number, commentId: number, payload: any) => {
    return http.patch(`/communities/${id}/posts/${postId}/comments/${commentId}`, payload);
}

export const deleteCommunityPostComment = (id: number, postId: number, commentId: number) => {
    return http.delete(`/communities/${id}/posts/${postId}/comments/${commentId}`);
}
