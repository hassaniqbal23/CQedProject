...
export const deleteSubject = (classId: number) => http.delete(`/classes/${classId}/delete-class`)

export const deleteStudent = (studentsId: number) => http.delete(`/students/${studentsId}/delete-student`)