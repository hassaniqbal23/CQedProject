...
const AlertDialogPortal = ({
  className,
  ...props
}: any | AlertDialogPrimitive.AlertDialogPortalProps) => (
...
>(({ className, children, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      'fixed inset-0 z-50 bg-[#344054B2] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className
    )}
    {...props}
    ref={ref}
