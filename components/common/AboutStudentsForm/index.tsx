    ...
    return (
        <>
            <div className="flex flex-col max-w-3xl mx-auto mt-8 mb-8">
                <div className='my-8' ><Progressbar heading='Doing great!' percentage={40} /></div>
                ...
                <div>
                    <Form {...form}>
                        <form onSubmit={() => console.log('submit')} className="flex flex-col gap-10">
                            <FormField
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea placeholder="Tell us about you. What makes you smile! What is unique about you?" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className='flex flex-col gap-1' >
                                        <FormLabel>Tell us about your culture and customs. What is most significant for you? Remember, what seems normal to you may be new for somebody else across the world. Share so they may learn.</FormLabel>
                                        <FormControl>
                                            <Textarea placeholder="Share the richness of your culture. What would you like people to know? What is special about where you live?" {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel>Upload pictures of what you wish to share - your culture, your pets, your favourite dish, your hobby...</FormLabel>
                                        <FormControl>
                                            <div className='grid grid-cols-4 gap-4 mt-2'>
                                                {[1, 2, 3, 4].map((item) => {
                                                    return <div key={item} className='p-3 w-full h-36 cursor-pointer border-2 border-dashed rounded flex items-center justify-center ' >
                                                        <ImagePlus />
                                                    </div>
                                                })}
                                            </div>
