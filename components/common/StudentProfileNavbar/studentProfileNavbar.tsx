  ...
  return (
    <div className='w-full h-[90px] flex justify-between bg-[#4146B8] rounded-sm'>
      <div className='flex flex-start mx-4 gap-3 items-center mt-4'>
        ...
        <div className='text-white font-montserrat font-semibold text-2xl mb-3.5'>{heading}</div>
      </div>
      <div className=''>
      
        <Button className=' h-[20px] px-[20px] py-[20px] mt-6 justify-center items-center  rounded-md bg-white  text-[#4146B8] mr-4'><MessageCircle className='gap-2'/>message</Button>
      </div>
    </div>
  );
};
